...
public class EPSpriteCM extends AbstractContainerManager<AuraClient, EPSpriteCE> {
	...
	public static final int ENTITY_WALK_STAND_UP = CURSEUR.nextVal();
	public static final int ENTITY_WALK_STAND_DOWN = CURSEUR.nextVal();
	public static final int ENTITY_WALK_STAND_LEFT = CURSEUR.nextVal();
	public static final int ENTITY_WALK_STAND_RIGHT = CURSEUR.nextVal();
	...
	public EPSpriteCE[] getSpriteToRegister() {
		return new EPSpriteCE[] {
			...
			new EPSpriteCE(ENTITY_WALK_STAND_UP, "ENTITY_WALK_STAND_UP", getSurfaceCM().getElement(EPSpriteSurfaceCM.ENTITY_BASE), 21, 21, false),
			new EPSpriteCE(ENTITY_WALK_STAND_DOWN, "ENTITY_WALK_STAND_DOWN", getSurfaceCM().getElement(EPSpriteSurfaceCM.ENTITY_BASE), 7, 7, false),
			new EPSpriteCE(ENTITY_WALK_STAND_LEFT, "ENTITY_WALK_STAND_LEFT", getSurfaceCM().getElement(EPSpriteSurfaceCM.ENTITY_BASE), 14, 14, false),
			new EPSpriteCE(ENTITY_WALK_STAND_RIGHT, "ENTITY_WALK_STAND_RIGHT", getSurfaceCM().getElement(EPSpriteSurfaceCM.ENTITY_BASE), 0, 0, false),
